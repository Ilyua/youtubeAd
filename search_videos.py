...
def youtube_search(key_word):
  ...
  for video_result in video_response.get("items", []):
    videos.append("{title}, ({lat},{lng}) https://www.youtube.com/watch?v={video_id}".format(
        ...
        lat=video_result.get("recordingDetails",{"location":{"latitude":"None"}})["location"]["latitude"],
        lng=video_result.get("recordingDetails",{"location":{"longitude":"None"}})["location"]["longitude"],
